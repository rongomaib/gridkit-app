...
] as MaterialSpec[]) registerMaterial(spec)
...
for (const spec of [
  ...
  { id: 'SS304', label: '304 stainless steel', category: 'steel', E: 1.93e11, G: 7.4e10, density: 7980 },
  { id: 'SS316', label: '316 stainless steel', category: 'steel', E: 1.93e11, G: 7.4e10, density: 7980 },
] as MaterialSpec[]) registerMaterial(spec)
