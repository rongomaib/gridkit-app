...
//
// Z: posts from z=0 (ground). FLOOR_Z = finished floor level = top face of floor beams.
//   Floor beam bottom:    FLOOR_Z − 3  (beam occupies [FLOOR_Z−3, FLOOR_Z])
...
export const parameters = {
  pitchDeg: {
    ...
    label: 'Roof pitch (°)',
    description:
      'Monopitch angle in degrees. Front wall always stays at 2400mm; back wall and engawa eave heights derive from this.',
    min: 5,
    max: 35,
    step: 1,
  },
...
export const parts = ({
  ...
  const BEAM_FL_Z = FLOOR_Z - 3  // floor beam bottom — top face is at FLOOR_Z
  const PANEL_Z = FLOOR_Z
  ...
  return [
    ...
    Beam120.X({ id: 'beam-fl-x-b-1', x: [POST_X[0] + 3, POST_X[1]], y: POST_Y_BACK, z: BEAM_FL_Z }),
    Beam120.X({ id: 'beam-fl-x-b-2', x: [POST_X[1] + 3, POST_X[2]], y: POST_Y_BACK, z: BEAM_FL_Z }),
    Beam120.X({ id: 'beam-fl-x-f-1', x: [POST_X[0] + 3, POST_X[1]], y: POST_Y_FRONT, z: BEAM_FL_Z }),
    Beam120.X({ id: 'beam-fl-x-f-2', x: [POST_X[1] + 3, POST_X[2]], y: POST_Y_FRONT, z: BEAM_FL_Z }),
    Beam120.X({ id: 'beam-fl-x-e-1', x: [POST_X[0] + 3, POST_X[1]], y: POST_Y_ENGAWA, z: BEAM_FL_Z }),
    Beam120.X({ id: 'beam-fl-x-e-2', x: [POST_X[1] + 3, POST_X[2]], y: POST_Y_ENGAWA, z: BEAM_FL_Z }),

    // ── Floor beams — Y direction ──────────────────────────────────────────
    Beam120.Y({
      id: 'beam-fl-y-w-int',
      x: POST_X[0],
      y: [POST_Y_BACK + 3, POST_Y_FRONT],
      z: BEAM_FL_Z,
    }),
    Beam120.Y({
      id: 'beam-fl-y-m-int',
    ...
    Beam120.Y({
      id: 'beam-fl-y-w-eng',
      x: POST_X[0],
      y: [POST_Y_FRONT + 3, POST_Y_ENGAWA],
      z: BEAM_FL_Z,
    }),
    Beam120.Y({
      id: 'beam-fl-y-m-eng',
    ...
    Beam120.X({
      id: 'roof-x-f-1',
      x: [POST_X[0] + 3, POST_X[1]],
      y: POST_Y_FRONT,
      z: ROOF_Z_FRONT,
    }),
    Beam120.X({
      id: 'roof-x-f-2',
      x: [POST_X[1] + 3, POST_X[2]],
      y: POST_Y_FRONT,
      z: ROOF_Z_FRONT,
    }),
    Beam120.X({
    ...
    WallFrame.XZ({
      id: 'wall-b-1-a',
      x: [POST_X[0] + 3, POST_X[0] + 23],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    WallFrame.XZ({
      id: 'wall-b-1-b',
      x: [POST_X[0] + 23, POST_X[0] + 43],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    WallFrame.XZ({
      id: 'wall-b-1-c',
      x: [POST_X[0] + 43, POST_X[1]],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    WallFrame.XZ({
      id: 'wall-b-2-a',
      x: [POST_X[1] + 3, POST_X[1] + 23],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    WallFrame.XZ({
      id: 'wall-b-2-b',
      x: [POST_X[1] + 23, POST_X[1] + 43],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    WallFrame.XZ({
      id: 'wall-b-2-c',
      x: [POST_X[1] + 43, POST_X[2]],
      y: POST_Y_BACK,
      z: [FLOOR_Z, POST_H_BACK],
    }),
    ...
    WallFrame.YZ({
      id: 'wall-w-a',
      x: POST_X[0],
      y: [POST_Y_BACK + 3, POST_Y_BACK + 23],
      z: [FLOOR_Z, POST_H_FRONT],
    }),
    WallFrame.YZ({
      id: 'wall-w-b',
      x: POST_X[0],
      y: [POST_Y_BACK + 23, POST_Y_BACK + 43],
      z: [FLOOR_Z, POST_H_FRONT],
    }),
    WallFrame.YZ({
      id: 'wall-w-c',
