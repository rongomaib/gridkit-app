/* @ts-self-types="./gridkit_solver.d.ts" */

/**
 * @param {string} model_json
 * @returns {string}
 */
export function solve(model_json) {
  let deferred2_0
  let deferred2_1
  try {
...
async function __wbg_init(module_or_path) {
  ...
  if (module_or_path === undefined) {
    module_or_path = new URL('gridkit_solver_bg.wasm', import.meta.url)
  }
  const imports = __wbg_get_imports()
